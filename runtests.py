...
FLAKE8_ARGS = ['drf_swagger_extras', 'tests', '--ignore=E501']

ISORT_ARGS = ['--recursive', '--check-only', '-o' 'uritemplate', '-p', 'tests', 'drf_swagger_extras', 'tests']
    ...
    if len(sys.argv) > 1:
        ...
        try:
            ...
            pytest_args = [
                ...
                'xml',
                '--cov',
                'drf_swagger_extras'] + pytest_args
